            ...
            @foreach ($notifications as $notification)
                <li @click="handleItemClick()">
                    <a
                        ...
                        href="#"
                    >
                            <span class="relative flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300">
                                <svg data-feather="user" width="20" height="20"></svg>
                            <span
